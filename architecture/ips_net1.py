...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=32, patch_size=32, in_chans=3, embed_dim=3072):
        super().__init__()
...
class IPSNet(nn.Module):
    ...
    def __init__(self, device, conf):
        ...
        self.pose_emb=nn.Parameter(torch.zeros(1, conf.N, self.D))
    ...
    def ips(self, patches):
        ...
        return mem_patch, mem_pos,mem_idx

    def forward(self, patches, mem_idx,mem_patch, mem_pos=None):
        """
